...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($findUser->tk_dangnhap != $_POST['cmnd']){
        ...
        if (isset($errors['hoten'])) {
            ...
            echo "<script>window.location.href= 'thembenhnhan.php?diachi=$diachi&namsinh=$namsinh&sdt=$sdt&cnmd=$cmnd';</script>";
        }
        if (isset($errors['diachi'])) {
            ...
            echo "<script>window.location.href= 'ql_benhnhan.php?hoten=$hoten&namsinh=$namsinh&sdt=$sdt&cnmd=$cmnd';</script>";
        }
        if (isset($errors['namsinh'])) {
            ...
            echo "<script>window.location.href= 'ql_benhnhan.php?diachi=$diachi&hoten=$hoten&sdt=$sdt&cnmd=$cmnd';</script>";
        }
        if (isset($errors['sdt'])) {
            $diachi = $_POST['diachi'];
            $namsinh= $_POST['namsinh'];
            ...
            echo "<script>window.location.href= 'ql_benhnhan.php?diachi=$diachi&namsinh=$namsinh&hoten=$hoten&cnmd=$cmnd';</script>";
        }
        if (isset($errors['cmnd'])) {
            ...
            echo "<script>window.location.href= 'ql_benhnhan.php?diachi=$diachi&namsinh=$namsinh&hoten=$hoten&sdt=$sdt';</script>";
        }
    }else {
